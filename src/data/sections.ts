...
export const contentBlocks: ContentBlockLike[] = [
  {
    ...
    key: "home-hero",
    label: "Hero",
    eyebrow: "Anne Eli Değmiş Gibi",
    title: "Kişiye özel, tatlı ve yüz güldüren tekstil detayları.",
    body: "ZeyDesign, gündelik kullanıma da hediye etmeye de uygun ürünleri biraz çiçekli, biraz neşeli, bolca samimi bir dille hazırlar.",
    ...
    payload: section("hero", {
      content: {
        ...
        title: "Kişiye özel, tatlı ve yüz güldüren tekstil detayları.",
        body: "ZeyDesign, gündelik kullanıma da hediye etmeye de uygun ürünleri biraz çiçekli, biraz neşeli, bolca samimi bir dille hazırlar.",
        highlight: "Tatlı detay, içten iletişim",
        caption: "Nakışlardan hediyelik setlere uzanan neşeli koleksiyon",
      },
      items: [
        { id: "stat-1", label: "Üretim", value: "Butik ve sevgi dolu" },
        { id: "stat-2", label: "Seçim", value: "Kişiye özel minik dokunuşlar" },
  ...
  },
  {
    ...
    title: "Sıcaklığı bol, kullanması kolay bir sipariş deneyimi",
    body: "Her üründe anlaşılır seçenekler, rahat iletişim ve iç açan küçük detaylar öne çıkıyor.",
    sortOrder: 3,
    visible: true,
    payload: section("promise-cards", {
      ...
      items: [
        { id: "card-1", title: "Tatlı seçimler", body: "Koleksiyon gündelik kullanımla hediye hissini aynı sepette buluşturur." },
        { id: "card-2", title: "Rahat iletişim", body: "Sipariş öncesi de sonrası da yazması kolay, resmi olmayan bir akış vardır." },
        { id: "card-3", title: "Neşeli vitrin", body: "Abartısız ama karakterli, küçük sürprizleri olan bir vitrin deneyimi sunulur." },
      ],
    }),
  },
  {
